...
<div class="bg-gray-50 py-12 sm:py-16">
    <div class="max-w-xl mx-auto px-4 sm:px-6">
        <div class="bg-white rounded-3xl shadow-xl border border-slate-200/80 p-8 sm:p-10 text-center space-y-6">
            ...
            {{-- SUCCESS ICON --}}
            <div class="w-20 h-20 mx-auto rounded-full bg-emerald-100 text-indigo-600 flex items-center justify-center text-4xl shadow-md animate-bounce">
                <i class="fa-solid fa-circle-check"></i>
            </div>

            {{-- TITLE & REG NUMBER --}}
            <div class="space-y-2">
                <span class="text-[11px] font-bold uppercase tracking-widest text-indigo-600 bg-indigo-50/60 px-3 py-1 rounded-full border border-indigo-200">
            ...
            <div class="space-y-4 pt-2">
                ...
                <div class="flex items-center justify-center space-x-3 pt-1">
                    ...
                    <button onclick="window.print()" class="text-xs text-indigo-600 hover:text-indigo-700 font-semibold px-4 py-2 rounded-lg hover:bg-indigo-50/60 transition cursor-pointer">
