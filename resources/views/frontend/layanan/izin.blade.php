...
<div class="bg-gradient-to-r from-indigo-950 via-indigo-900 to-blue-950 border-b border-indigo-500/20 text-white py-10 sm:py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center space-x-3">
            <div class="w-10 h-10 rounded-xl bg-emerald-100 text-indigo-600 flex items-center justify-center font-bold text-xl shadow-md">
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-14 space-y-10">
    ...
    <div class="bg-white rounded-3xl p-6 sm:p-10 border border-gray-200/80 shadow-md space-y-6 reveal-fade-up delay-2">
        <form action="{{ route('layanan.izin.submit') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            {{-- SUBMIT BUTTON --}}
            <div class="pt-2">
                <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold text-sm py-3 rounded-md shadow-md hover:shadow-lg transition cursor-pointer uppercase tracking-wider">
                    KIRIM
                </button>
            </div>
