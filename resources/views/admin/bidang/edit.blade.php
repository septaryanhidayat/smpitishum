        ...
        <div class="bg-white p-6 sm:p-8 rounded-3xl shadow-xs border border-slate-200/80 space-y-5">
            ...
            <div class="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <button type="button" onclick="document.getElementById('icon').value='fa-solid fa-hotel'" class="text-[11px] bg-white hover:bg-indigo-50/60 hover:text-indigo-600 border border-slate-200 px-3 py-1.5 rounded-lg transition font-medium">Asrama Siswa</button>
